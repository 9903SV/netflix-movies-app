...
const MoviePage = props => {
  ...
  const renderMovieContentContainer = movieData => (
  ...
  const renderMovieDetailsContainer = (movieData, isLoading) => (
  ...
  const renderMoreMoviesContainer = (movieData, isLoading) => (
    <div>
  ...
  const renderMovieBottomContainer = (movieData, isLoading) => (
...
//   renderMovieBottomContainer = (movieData, isLoading) => (
//     <div className="movie-bottom-container">
//       {this.renderMovieDetailsContainer(movieData, isLoading)}
//       {this.renderMoreMoviesContainer(movieData, isLoading)}
//     </div>
//   )
...
//             />
//           ) : (
//             this.renderMovieContentContainer(movieData)
//           )}
//         </div>
//         {isLoading ? (
//           <Loader type="TailSpin" color="red" height={50} width={50} />
//         ) : (
//           this.renderMovieBottomContainer(movieData, isLoading)
//         )}
//       </div>
//     )
//   }
